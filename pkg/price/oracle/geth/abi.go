...
const megapokerJSONABI = `[{"inputs":[],"name":"last","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"poke","outputs":[],"stateMutability":"nonpayable","type":"function"}]`

var medianABI abi.ABI
var megapokerABI abi.ABI
...
func init() {
	...
	megapokerABI, err = abi.JSON(strings.NewReader(megapokerJSONABI))
	if err != nil {
		panic(err.Error())
	}
}
